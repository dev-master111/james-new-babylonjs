...
declare module 'babylonjs-gui/2D/advancedDynamicTexture' {
    import { DynamicTexture, Nullable, Layer, Viewport, Scene, Vector3, Matrix, Vector2, AbstractMesh } from "james-babylonjs";
...
declare module 'babylonjs-gui/2D/math2D' {
    import { Vector2, Nullable } from "james-babylonjs";
    /**
...
declare module 'babylonjs-gui/2D/multiLinePoint' {
    ...
    import { Control } from "babylonjs-gui/2D/controls/control";
    import { AbstractMesh, Nullable, Vector2 } from "james-babylonjs";
    /**
...
declare module 'babylonjs-gui/2D/style' {
    import { IDisposable, Observable } from "james-babylonjs";
...
declare module 'babylonjs-gui/3D/gui3DManager' {
    import { IDisposable, Scene, Nullable, UtilityLayerRenderer, Observable, Vector3, Material } from "james-babylonjs";
...
declare module 'babylonjs-gui/3D/vector3WithInfo' {
    import { Vector3 } from "james-babylonjs";
    /**
...
declare module 'babylonjs-gui/2D/controls/button' {
    ...
    import { Control } from "babylonjs-gui/2D/controls/control";
    import { Vector2 } from "james-babylonjs";
    /**
...
declare module 'babylonjs-gui/2D/controls/checkbox' {
    ...
    import { Observable, Vector2 } from "james-babylonjs";
...
declare module 'babylonjs-gui/2D/controls/colorpicker' {
    import { Control } from "babylonjs-gui/2D/controls/control";
    import { Color3, Observable, Vector2 } from "james-babylonjs";
    import { Measure } from "babylonjs-gui/2D/measure";
...
declare module 'babylonjs-gui/2D/controls/container' {
    import { Control } from "babylonjs-gui/2D/controls/control";
    import { Measure } from "babylonjs-gui/2D/measure";
    import { Nullable } from "james-babylonjs";
    import { AdvancedDynamicTexture } from "babylonjs-gui/2D/advancedDynamicTexture";
    /**
...
declare module 'babylonjs-gui/2D/controls/control' {
    ...
    import { AdvancedDynamicTexture } from "babylonjs-gui/2D/advancedDynamicTexture";
    import { ValueAndUnit } from "babylonjs-gui/2D/valueAndUnit";
    import { Nullable, Vector2, AbstractMesh, Observable, Vector3, Scene } from "james-babylonjs";
    import { Measure } from "babylonjs-gui/2D/measure";
    import { Style } from "babylonjs-gui/2D/style";
...
declare module 'babylonjs-gui/2D/controls/inputText' {
    ...
    import { Nullable, Observable, Vector2 } from "james-babylonjs";
    import { Measure } from "babylonjs-gui/2D/measure";
...
declare module 'babylonjs-gui/2D/controls/line' {
    import { Control } from "babylonjs-gui/2D/controls/control";
    import { Vector3, Scene } from "james-babylonjs";
    import { Measure } from "babylonjs-gui/2D/measure";
...
declare module 'babylonjs-gui/2D/controls/multiLine' {
    ...
    import { AbstractMesh } from "james-babylonjs";
    import { Measure } from "babylonjs-gui/2D/measure";
    /**
...
declare module 'babylonjs-gui/2D/controls/textBlock' {
    import { Observable } from "james-babylonjs";
    import { Measure } from "babylonjs-gui/2D/measure";
    import { Control } from "babylonjs-gui/2D/controls/control";
    /**
    ...
    export class TextBlock extends Control {
            ...
            text: string;
            /**
             * Gets or sets text horizontal alignment (JBABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER by default)
             */
            textHorizontalAlignment: number;
            /**
             * Gets or sets text vertical alignment (JBABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER by default)
             */
...
declare module 'babylonjs-gui/2D/controls/virtualKeyboard' {
    import { StackPanel } from "babylonjs-gui/2D/controls/stackPanel";
    import { Observable, Nullable } from "james-babylonjs";
    import { InputText } from "babylonjs-gui/2D/controls/inputText";
    /**
...
declare module 'babylonjs-gui/3D/controls/abstractButton3D' {
    import { Control3D } from "babylonjs-gui/3D/controls/control3D";
    import { TransformNode, Scene } from "james-babylonjs";
    /**
...
declare module 'babylonjs-gui/3D/controls/button3D' {
    ...
    import { Material, int, Scene, TransformNode, AbstractMesh } from "james-babylonjs";
    import { AdvancedDynamicTexture } from "babylonjs-gui/2D/advancedDynamicTexture";
    import { Control } from "babylonjs-gui/2D/controls/control";
    /**
...
declare module 'babylonjs-gui/3D/controls/container3D' {
    import { Control3D } from "babylonjs-gui/3D/controls/control3D";
    import { Scene, Nullable, TransformNode } from "james-babylonjs";
    /**
...
declare module 'babylonjs-gui/3D/controls/control3D' {
    import { IDisposable, IBehaviorAware, Nullable, TransformNode, Vector3, Observable, Behavior, AbstractMesh, Scene } from "james-babylonjs";
...
declare module 'babylonjs-gui/3D/controls/cylinderPanel' {
    ...
    import { float, Vector3 } from "james-babylonjs";
    import { Control3D } from "babylonjs-gui/3D/controls/control3D";
    /**
...
declare module 'babylonjs-gui/3D/controls/holographicButton' {
    ...
    import { Mesh, StandardMaterial, Nullable, Scene, TransformNode } from "james-babylonjs";
...
declare module 'babylonjs-gui/3D/controls/meshButton3D' {
    import { Scene, TransformNode, AbstractMesh, Mesh } from "james-babylonjs";
    import { Button3D } from "babylonjs-gui/3D/controls/button3D";
    /**
...
declare module 'babylonjs-gui/3D/controls/volumeBasedPanel' {
    import { Container3D } from "babylonjs-gui/3D/controls/container3D";
    import { int, Vector3 } from "james-babylonjs";
    import { Control3D } from "babylonjs-gui/3D/controls/control3D";
    /**
    ...
    export abstract class VolumeBasedPanel extends Container3D {
            ...
            margin: number;
            /**
                * Gets or sets the orientation to apply to all controls (JBABYLON.Container3D.FaceOriginReversedOrientation by default)
...
declare module 'babylonjs-gui/3D/materials/fluentMaterial' {
    import { MaterialDefines, PushMaterial, Color3, Color4, Vector3, Scene, Nullable, BaseTexture, AbstractMesh, SubMesh, Matrix, Mesh } from "james-babylonjs";
    /** @hidden */
...
declare module JBABYLON.GUI {
    ...
    export interface IFocusableControl {
            ...
            /**
                ...
                * @returns an array of controls
                */
            keepsFocusWith(): JBABYLON.Nullable<Control[]>;
    }
    /**
        * Class used to create texture to support 2D GUI elements
        * @see http://doc.babylonjs.com/how_to/gui
        */
    export class AdvancedDynamicTexture extends JBABYLON.DynamicTexture {
            /** @hidden */
            _rootContainer: Container;
            /** @hidden */
            _lastPickedControl: Control;
            ...
            _shouldBlockPointer: boolean;
            /** @hidden */
            _layerToDispose: JBABYLON.Nullable<JBABYLON.Layer>;
            /** @hidden */
            _linkedControls: Control[];
            /**
                * Gets or sets a boolean defining if alpha is stored as premultiplied
            ...
            /**
                * Gets the underlying layer used to render the texture when in fullscreen mode
                */
            readonly layer: JBABYLON.Nullable<JBABYLON.Layer>;
            /**
                * Gets the root container control
                */
            readonly rootContainer: Container;
            /**
                * Gets or sets the current focused control
                */
            focusedControl: JBABYLON.Nullable<IFocusableControl>;
            /**
                * Gets or sets a boolean indicating if the texture must be rendered in background or foreground when in fullscreen mode
                */
            isForeground: boolean;
            /**
                ...
                * @param samplingMode defines the texture sampling mode (Texture.NEAREST_SAMPLINGMODE by default)
                */
            constructor(name: string, width: number | undefined, height: number | undefined, scene: JBABYLON.Nullable<JBABYLON.Scene>, generateMipMaps?: boolean, samplingMode?: number);
            /**
                * Function used to execute a function on all controls
                * @param func defines the function to execute
                * @param container defines the container where controls belong. If null the root container will be used
            ...
            dispose(): void;
            /** @hidden */
            _getGlobalViewport(scene: JBABYLON.Scene): JBABYLON.Viewport;
            /**
                * Get screen coordinates for a vector3
                * @param position defines the position to project
                * @param worldMatrix defines the world matrix to use
                * @returns the projected position
                */
            getProjectedPosition(position: JBABYLON.Vector3, worldMatrix: JBABYLON.Matrix): JBABYLON.Vector2;
            /** @hidden */
            _changeCursor(cursor: string): void;
            /** @hidden */
            _cleanControlAfterRemovalFromList(list: {
            ...
            /**
                ...
                * @param supportPointerMove defines a boolean indicating if pointer move events must be catched as well
                */
            attachToMesh(mesh: JBABYLON.AbstractMesh, supportPointerMove?: boolean): void;
            /**
                * Move the focus to a specific control
                * @param control defines the control which will receive the focus
                */
            ...
            /**
                ...
                * @returns a new AdvancedDynamicTexture
                */
            static CreateForMesh(mesh: JBABYLON.AbstractMesh, width?: number, height?: number, supportPointerMove?: boolean, onlyAlphaTesting?: boolean): AdvancedDynamicTexture;
            /**
                * Creates a new AdvancedDynamicTexture in fullscreen mode.
                * In this mode the texture will rely on a layer for its rendering.
                * This allows it to be treated like any other layer.
                ...
                * @returns a new AdvancedDynamicTexture
                */
            static CreateFullscreenUI(name: string, foreground?: boolean, scene?: JBABYLON.Nullable<JBABYLON.Scene>, sampling?: number): AdvancedDynamicTexture;
    }
}
declare module JBABYLON.GUI {
    /**
        * Class used to transport JBABYLON.Vector2 information for pointer events
        */
    export class Vector2WithInfo extends JBABYLON.Vector2 {
            /** defines the current mouse button index */
            buttonIndex: number;
            /**
                * Creates a new Vector2WithInfo
                ...
                * @param buttonIndex defines the current mouse button index
                */
            constructor(source: JBABYLON.Vector2, 
            /** defines the current mouse button index */
            buttonIndex?: number);
    }
    /** Class used to provide 2D matrix features */
    export class Matrix2D {
            ...
            /**
                ...
                * @returns the current matrix
                */
            transformCoordinates(x: number, y: number, result: JBABYLON.Vector2): Matrix2D;
            /**
                * Creates an identity matrix
                * @returns a new matrix
                */
            ...
            /**
                ...
                * @param result defines the target matrix
                */
            static ComposeToRef(tx: number, ty: number, angle: number, scaleX: number, scaleY: number, parentMatrix: JBABYLON.Nullable<Matrix2D>, result: Matrix2D): void;
    }
}
declare module JBABYLON.GUI {
    /**
...
declare module JBABYLON.GUI {
    ...
    export class MultiLinePoint {
            ...
            y: string | number;
            /** Gets or sets the control associated with this point */
            control: JBABYLON.Nullable<Control>;
            /** Gets or sets the mesh associated with this point */
            mesh: JBABYLON.Nullable<JBABYLON.AbstractMesh>;
            /** Resets links */
            resetLinks(): void;
            /**
                * Gets a translation vector
...
declare module JBABYLON.GUI {
    /**
        ...
        * Only support font related properties so far
        */
    export class Style implements JBABYLON.IDisposable {
            /** @hidden */
            _host: AdvancedDynamicTexture;
            /** @hidden */
            _fontSize: ValueAndUnit;
            /**
                * JBABYLON.Observable raised when the style values are changed
                */
            onChangedObservable: JBABYLON.Observable<Style>;
            /**
                * Creates a new style object
                * @param host defines the AdvancedDynamicTexture which hosts this style
                */
...
declare module JBABYLON.GUI {
    /**
        ...
        * @see http://doc.babylonjs.com/how_to/gui3d
        */
    export class GUI3DManager implements JBABYLON.IDisposable {
            /** @hidden */
            _lastPickedControl: Control3D;
            /** @hidden */
            _lastControlOver: {
            ...
            /**
                * JBABYLON.Observable raised when the point picked by the pointer events changed
                */
            onPickedPointChangedObservable: JBABYLON.Observable<JBABYLON.Nullable<JBABYLON.Vector3>>;
            /** @hidden */
            _sharedMaterials: {
                    [key: string]: JBABYLON.Material;
            };
            /** Gets the hosting scene */
            readonly scene: JBABYLON.Scene;
            /** Gets associated utility layer */
            readonly utilityLayer: JBABYLON.Nullable<JBABYLON.UtilityLayerRenderer>;
            /**
                * Creates a new GUI3DManager
                * @param scene
                */
            constructor(scene?: JBABYLON.Scene);
            /**
                * Gets the root container
                */
            readonly rootContainer: Container3D;
...
declare module JBABYLON.GUI {
    /**
        * Class used to transport JBABYLON.Vector3 information for pointer events
        */
    export class Vector3WithInfo extends JBABYLON.Vector3 {
            /** defines the current mouse button index */
            buttonIndex: number;
            /**
                * Creates a new Vector3WithInfo
                ...
                * @param buttonIndex defines the current mouse button index
                */
            constructor(source: JBABYLON.Vector3, 
            /** defines the current mouse button index */
            buttonIndex?: number);
    }
}
declare module JBABYLON.GUI {
    ...
    export class Button extends Rectangle {
            ...
            _onPointerOut(target: Control): void;
            /** @hidden */
            _onPointerDown(target: Control, coordinates: JBABYLON.Vector2, pointerId: number, buttonIndex: number): boolean;
            /** @hidden */
            _onPointerUp(target: Control, coordinates: JBABYLON.Vector2, pointerId: number, buttonIndex: number, notifyClick: boolean): void;
            /**
                * Creates a new button made with an image and a text
                * @param name defines the name of the button
                * @param text defines the text of the button
...
declare module JBABYLON.GUI {
    ...
    export class Checkbox extends Control {
            ...
            thickness: number;
            /**
                * JBABYLON.Observable raised when isChecked property changes
                */
            onIsCheckedChangedObservable: JBABYLON.Observable<boolean>;
            /** Gets or sets a value indicating the ratio between overall size and check size */
            checkSizeRatio: number;
            /** Gets or sets background color */
            background: string;
...
declare module JBABYLON.GUI {
    ...
    export class ColorPicker extends Control {
            name?: string | undefined;
            /**
                * JBABYLON.Observable raised when the value changes
                */
            onValueChangedObservable: JBABYLON.Observable<JBABYLON.Color3>;
            /** Gets or sets the color of the color picker */
            value: JBABYLON.Color3;
            /** Gets or sets control width */
            width: string | number;
            /** Gets or sets control height */
            height: string | number;
            ...
            _draw(parentMeasure: Measure, context: CanvasRenderingContext2D): void;
            _onPointerDown(target: Control, coordinates: JBABYLON.Vector2, pointerId: number, buttonIndex: number): boolean;
            _onPointerMove(target: Control, coordinates: JBABYLON.Vector2): void;
            _onPointerUp(target: Control, coordinates: JBABYLON.Vector2, pointerId: number, buttonIndex: number, notifyClick: boolean): void;
    }
}
declare module JBABYLON.GUI {
    ...
    export class Container extends Control {
            ...
            /**
                ...
                * @returns the child control if found
                */
            getChildByName(name: string): JBABYLON.Nullable<Control>;
            /**
                * Gets a child using its type and its name
                * @param name defines the child name to look for
                * @param type defines the child type to look for
                * @returns the child control if found
                */
            getChildByType(name: string, type: string): JBABYLON.Nullable<Control>;
            /**
                * Search for a specific control in children
                * @param control defines the control to look for
                * @returns true if the control is in child list
            ...
            /**
                ...
                * @returns the current container
                */
            addControl(control: JBABYLON.Nullable<Control>): Container;
            /**
                * Removes all controls from the current container
                * @returns the current container
                */
            ...
            protected _localDraw(context: CanvasRenderingContext2D): void;
            /** @hidden */
            _link(root: JBABYLON.Nullable<Container>, host: AdvancedDynamicTexture): void;
            /** @hidden */
            _draw(parentMeasure: Measure, context: CanvasRenderingContext2D): void;
            /** @hidden */
            _processPicking(x: number, y: number, type: number, pointerId: number, buttonIndex: number): boolean;
...
declare module JBABYLON.GUI {
    ...
    export class Control {
            ...
            name?: string | undefined;
            /** @hidden */
            _root: JBABYLON.Nullable<Container>;
            /** @hidden */
            _host: AdvancedDynamicTexture;
            /** Gets or sets the control parent */
            parent: JBABYLON.Nullable<Container>;
            /** @hidden */
            _currentMeasure: Measure;
            /** @hidden */
            _width: ValueAndUnit;
            ...
            protected _invertTransformMatrix: Matrix2D;
            /** @hidden */
            protected _transformedPosition: JBABYLON.Vector2;
            /** @hidden */
            _linkedMesh: JBABYLON.Nullable<JBABYLON.AbstractMesh>;
            protected _isEnabled: boolean;
            protected _disabledColor: string;
            /** @hidden */
            _tag: any;
             ...
             * An event triggered when the pointer move over the control.
             */
            onPointerMoveObservable: JBABYLON.Observable<JBABYLON.Vector2>;
            /**
             * An event triggered when the pointer move out of the control.
             */
            onPointerOutObservable: JBABYLON.Observable<Control>;
            /**
             * An event triggered when the pointer taps the control
             */
            onPointerDownObservable: JBABYLON.Observable<Vector2WithInfo>;
            /**
             * An event triggered when pointer up
             */
            onPointerUpObservable: JBABYLON.Observable<Vector2WithInfo>;
            /**
             * An event triggered when a control is clicked on
             */
            onPointerClickObservable: JBABYLON.Observable<Vector2WithInfo>;
            /**
             * An event triggered when pointer enters the control
             */
            onPointerEnterObservable: JBABYLON.Observable<Control>;
            /**
             * An event triggered when the control is marked as dirty
             */
            onDirtyObservable: JBABYLON.Observable<Control>;
            /**
            * An event triggered after the control is drawn
            */
            onAfterDrawObservable: JBABYLON.Observable<Control>;
            /** Gets or set information about font offsets (used to render and align text) */
            fontOffset: {
                    ascent: number;
                    height: number;
            ...
            /**
                * Gets the current linked mesh (or null if none)
                */
            readonly linkedMesh: JBABYLON.Nullable<JBABYLON.AbstractMesh>;
            /**
                * Gets or sets a value indicating the padding to use on the left of the control
                * @see http://doc.babylonjs.com/how_to/gui#position-and-size
                */
            ...
            /**
                ...
                * @returns the new coordinates in local space
                */
            getLocalCoordinates(globalCoordinates: JBABYLON.Vector2): JBABYLON.Vector2;
            /**
                * Gets coordinates in local control space
                * @param globalCoordinates defines the coordinates to transform
                * @param result defines the target vector2 where to store the result
                * @returns the current control
                */
            getLocalCoordinatesToRef(globalCoordinates: JBABYLON.Vector2, result: JBABYLON.Vector2): Control;
            /**
                * Gets coordinates in parent local control space
                * @param globalCoordinates defines the coordinates to transform
                * @returns the new coordinates in parent local space
                */
            getParentLocalCoordinates(globalCoordinates: JBABYLON.Vector2): JBABYLON.Vector2;
            /**
                * Move the current control to a vector3 position projected onto the screen.
                * @param position defines the target position
                * @param scene defines the hosting scene
                */
            moveToVector3(position: JBABYLON.Vector3, scene: JBABYLON.Scene): void;
            /**
                * Link current control with a target mesh
                * @param mesh defines the mesh to link with
                * @see http://doc.babylonjs.com/how_to/gui#tracking-positions
                */
            linkWithMesh(mesh: JBABYLON.Nullable<JBABYLON.AbstractMesh>): void;
            /** @hidden */
            _moveToProjectedPosition(projectedPosition: JBABYLON.Vector3): void;
            /** @hidden */
            _markMatrixAsDirty(): void;
            /** @hidden */
            _flagDescendantsAsMatrixDirty(): void;
            ...
            _onPointerUp(target: Control, coordinates: JBABYLON.Vector2, pointerId: number, buttonIndex: number, notifyClick: boolean): void;
            /** @hidden */
            _forcePointerUp(pointerId?: JBABYLON.Nullable<number>): void;
            /** @hidden */
            _processObservables(type: number, x: number, y: number, pointerId: number, buttonIndex: number): boolean;
            /** Releases associated resources */
            dispose(): void;
...
declare module JBABYLON.GUI {
    ...
    export class Image extends Control {
            ...
            /**
                * Gets or sets image source url
                */
            source: JBABYLON.Nullable<string>;
            /**
                * Gets or sets the cell width to use when animation sheet is enabled
                * @see http://doc.babylonjs.com/how_to/gui#image
                */
            ...
            /**
                ...
                * @param url defines the image url
                */
            constructor(name?: string | undefined, url?: JBABYLON.Nullable<string>);
            protected _getTypeName(): string;
            /** Force the control to synchronize with its content */
            synchronizeSizeWithContent(): void;
            _draw(parentMeasure: Measure, context: CanvasRenderingContext2D): void;
...
declare module JBABYLON.GUI {
    ...
    export class InputText extends Control implements IFocusableControl {
            name?: string | undefined;
            /** @hidden */
            _connectedVirtualKeyboard: JBABYLON.Nullable<VirtualKeyboard>;
            /** Gets or sets a string representing the message displayed on mobile when the control gets the focus */
            promptMessage: string;
            /** JBABYLON.Observable raised when the text changes */
            onTextChangedObservable: JBABYLON.Observable<InputText>;
            /** JBABYLON.Observable raised just before an entered character is to be added */
            onBeforeKeyAddObservable: JBABYLON.Observable<InputText>;
            /** JBABYLON.Observable raised when the control gets the focus */
            onFocusObservable: JBABYLON.Observable<InputText>;
            /** JBABYLON.Observable raised when the control loses the focus */
            onBlurObservable: JBABYLON.Observable<InputText>;
            /** Gets or sets the maximum width allowed by the control */
            maxWidth: string | number;
            /** Gets the maximum width allowed by the control in pixels */
            readonly maxWidthInPixels: number;
...
declare module JBABYLON.GUI {
    ...
    export class Line extends Control {
            ...
            /**
                * Move one end of the line given 3D cartesian coordinates.
                * @param position Targeted world position
                * @param scene JBABYLON.Scene
                * @param end (opt) Set to true to assign x2 and y2 coordinates of the line. Default assign to x1 and y1.
                */
            moveToVector3(position: JBABYLON.Vector3, scene: JBABYLON.Scene, end?: boolean): void;
            /**
                * Move one end of the line to a position in screen absolute space.
                * @param projectedPosition Position in screen absolute space (X, Y)
                * @param end (opt) Set to true to assign x2 and y2 coordinates of the line. Default assign to x1 and y1.
                */
            _moveToProjectedPosition(projectedPosition: JBABYLON.Vector3, end?: boolean): void;
    }
}
declare module JBABYLON.GUI {
    /**
...
declare module JBABYLON.GUI {
    ...
    export class RadioButton extends Control {
            ...
            /** Gets or sets group name */
            group: string;
            /** JBABYLON.Observable raised when isChecked is changed */
            onIsCheckedChangedObservable: JBABYLON.Observable<boolean>;
            /** Gets or sets a value indicating the ratio between overall size and check size */
            checkSizeRatio: number;
            /** Gets or sets background color */
...
declare module JBABYLON.GUI {
    ...
    export class TextBlock extends Control {
             ...
             * An event triggered after the text is changed
             */
            onTextChangedObservable: JBABYLON.Observable<TextBlock>;
            /**
             * An event triggered after the text was broken up into lines
             */
            onLinesReadyObservable: JBABYLON.Observable<TextBlock>;
            /**
                * Return the line list (you may need to use the onLinesReadyObservable to make sure the list is ready)
                */
            readonly lines: any[];
...
declare module JBABYLON.GUI {
    ...
    /**
        ...
        */
    export class VirtualKeyboard extends StackPanel {
            /** JBABYLON.Observable raised when a key is pressed */
            onKeyPressObservable: JBABYLON.Observable<string>;
            /** Gets or sets default key button width */
            defaultButtonWidth: string;
            /** Gets or sets default key button height */
            defaultButtonHeight: string;
            ...
            applyShiftState(shiftState: number): void;
            /** Gets the input text control currently attached to the keyboard */
            readonly connectedInputText: JBABYLON.Nullable<InputText>;
            /**
                * Connects the keyboard with an input text control
                *
                * @param input defines the target control
...
declare module JBABYLON.GUI {
    ...
    export class Slider extends Control {
            name?: string | undefined;
            /** JBABYLON.Observable raised when the sldier value changes */
            onValueChangedObservable: JBABYLON.Observable<number>;
            /** Gets or sets border color */
            borderColor: string;
            /** Gets or sets background color */
            background: string;
...
declare module JBABYLON.GUI {
    ...
    export class AbstractButton3D extends Control3D {
            ...
            constructor(name?: string);
            protected _getTypeName(): string;
            protected _createNode(scene: JBABYLON.Scene): JBABYLON.TransformNode;
    }
}
declare module JBABYLON.GUI {
    /**
    ...
    export class Button3D extends AbstractButton3D {
            /** @hidden */
            protected _currentMaterial: JBABYLON.Material;
            /**
                * Gets or sets the texture resolution used to render content (512 by default)
                */
            contentResolution: JBABYLON.int;
            /**
                * Gets or sets the texture scale ratio used to render content (2 by default)
                */
            contentScaleRatio: number;
            ...
            protected _getTypeName(): string;
            protected _createNode(scene: JBABYLON.Scene): JBABYLON.TransformNode;
            protected _affectMaterial(mesh: JBABYLON.AbstractMesh): void;
            /**
                * Releases all associated resources
                */
            dispose(): void;
...
declare module JBABYLON.GUI {
    ...
    export class Container3D extends Control3D {
            ...
            /**
                ...
                */
            protected _arrangeChildren(): void;
            protected _createNode(scene: JBABYLON.Scene): JBABYLON.Nullable<JBABYLON.TransformNode>;
            /**
                * Removes a control from the children of this control
                * @param control defines the control to remove
                * @returns the current container
...
declare module JBABYLON.GUI {
    /**
        * Class used as base class for controls
        */
    export class Control3D implements JBABYLON.IDisposable, JBABYLON.IBehaviorAware<Control3D> {
            /** Defines the control name */
            name?: string | undefined;
            /** @hidden */
            _host: GUI3DManager;
            /** Gets or sets the control position  in world space */
            position: JBABYLON.Vector3;
            /** Gets or sets the control scaling  in world space */
            scaling: JBABYLON.Vector3;
            /** Callback used to start pointer enter animation */
            pointerEnterAnimation: () => void;
            /** Callback used to start pointer out animation */
            pointerOutAnimation: () => void;
             ...
             * An event triggered when the pointer move over the control
             */
            onPointerMoveObservable: JBABYLON.Observable<JBABYLON.Vector3>;
            /**
                * An event triggered when the pointer move out of the control
                */
            onPointerOutObservable: JBABYLON.Observable<Control3D>;
            /**
                * An event triggered when the pointer taps the control
                */
            onPointerDownObservable: JBABYLON.Observable<Vector3WithInfo>;
            /**
                * An event triggered when pointer is up
                */
            onPointerUpObservable: JBABYLON.Observable<Vector3WithInfo>;
            /**
                * An event triggered when a control is clicked on (with a mouse)
                */
            onPointerClickObservable: JBABYLON.Observable<Vector3WithInfo>;
            /**
                * An event triggered when pointer enters the control
                */
            onPointerEnterObservable: JBABYLON.Observable<Control3D>;
            /**
                * Gets or sets the parent container
                */
            parent: JBABYLON.Nullable<Container3D>;
            /**
                * Gets the list of attached behaviors
                * @see http://doc.babylonjs.com/features/behaviour
                */
            readonly behaviors: JBABYLON.Behavior<Control3D>[];
            /**
                * Attach a behavior to the control
                * @see http://doc.babylonjs.com/features/behaviour
                * @param behavior defines the behavior to attach
                * @returns the current control
                */
            addBehavior(behavior: JBABYLON.Behavior<Control3D>): Control3D;
            /**
                * Remove an attached behavior
                * @see http://doc.babylonjs.com/features/behaviour
                * @param behavior defines the behavior to attach
                * @returns the current control
                */
            removeBehavior(behavior: JBABYLON.Behavior<Control3D>): Control3D;
            /**
                * Gets an attached behavior by name
                * @param name defines the name of the behavior to look for
                * @see http://doc.babylonjs.com/features/behaviour
                * @returns null if behavior was not found else the requested behavior
                */
            getBehaviorByName(name: string): JBABYLON.Nullable<JBABYLON.Behavior<Control3D>>;
            /** Gets or sets a boolean indicating if the control is visible */
            isVisible: boolean;
            /**
                * Creates a new control
            ...
            /**
                * Gets the transform node used by this control
                */
            readonly node: JBABYLON.Nullable<JBABYLON.TransformNode>;
            /**
                * Gets the mesh used to render this control
                */
            readonly mesh: JBABYLON.Nullable<JBABYLON.AbstractMesh>;
            /**
                * Link the control as child of the given node
                * @param node defines the node to link to. Use null to unlink the control
                * @returns the current control
                */
            linkToTransformNode(node: JBABYLON.Nullable<JBABYLON.TransformNode>): Control3D;
            /** @hidden **/
            _prepareNode(scene: JBABYLON.Scene): void;
            /**
                * Node creation.
                * Can be overriden by children
                * @param scene defines the scene where the node must be attached
                * @returns the attached node or null if none. Must return a JBABYLON.Mesh or JBABYLON.AbstractMesh if there is an atttached visible object
                */
            protected _createNode(scene: JBABYLON.Scene): JBABYLON.Nullable<JBABYLON.TransformNode>;
            /**
                * Affect a material to the given mesh
            ...
            protected _affectMaterial(mesh: JBABYLON.AbstractMesh): void;
            /** @hidden */
            _onPointerMove(target: Control3D, coordinates: JBABYLON.Vector3): void;
            /** @hidden */
            _onPointerEnter(target: Control3D): boolean;
            /** @hidden */
            _onPointerOut(target: Control3D): void;
            /** @hidden */
            _onPointerDown(target: Control3D, coordinates: JBABYLON.Vector3, pointerId: number, buttonIndex: number): boolean;
            /** @hidden */
            _onPointerUp(target: Control3D, coordinates: JBABYLON.Vector3, pointerId: number, buttonIndex: number, notifyClick: boolean): void;
            /** @hidden */
            forcePointerUp(pointerId?: JBABYLON.Nullable<number>): void;
            /** @hidden */
            _processObservables(type: number, pickedPoint: JBABYLON.Vector3, pointerId: number, buttonIndex: number): boolean;
            /** @hidden */
            _disposeNode(): void;
            /**
                * Releases all associated resources
...
declare module JBABYLON.GUI {
    ...
    export class CylinderPanel extends VolumeBasedPanel {
            /**
                * Gets or sets the radius of the cylinder where to project controls (5 by default)
                */
            radius: JBABYLON.float;
            protected _mapGridNode(control: Control3D, nodePosition: JBABYLON.Vector3): void;
    }
}
declare module JBABYLON.GUI {
    /**
    ...
    export class HolographicButton extends Button3D {
            /**
                * Text to be displayed on the tooltip shown when hovering on the button. When set to null tooltip is disabled. (Default: null)
                */
            tooltipText: JBABYLON.Nullable<string>;
            /**
                * Gets or sets text for the button
                */
            text: string;
            ...
            /**
                * Gets the plate material used by this button
                */
            readonly plateMaterial: JBABYLON.StandardMaterial;
            /**
                * Gets a boolean indicating if this button shares its material with other HolographicButtons
                */
            readonly shareMaterials: boolean;
            ...
            protected _createNode(scene: JBABYLON.Scene): JBABYLON.TransformNode;
            protected _applyFacade(facadeTexture: AdvancedDynamicTexture): void;
            protected _affectMaterial(mesh: JBABYLON.Mesh): void;
            /**
                * Releases all associated resources
                */
            dispose(): void;
...
declare module JBABYLON.GUI {
    ...
    export class MeshButton3D extends Button3D {
            /** @hidden */
            protected _currentMesh: JBABYLON.Mesh;
            /**
                * Creates a new 3D button based on a mesh
                * @param mesh mesh to become a 3D button
                * @param name defines the control name
                */
            constructor(mesh: JBABYLON.Mesh, name?: string);
            protected _getTypeName(): string;
            protected _createNode(scene: JBABYLON.Scene): JBABYLON.TransformNode;
            protected _affectMaterial(mesh: JBABYLON.AbstractMesh): void;
    }
...
declare module JBABYLON.GUI {
    ...
    export abstract class VolumeBasedPanel extends Container3D {
            ...
            protected _arrangeChildren(): void;
            /** Child classes must implement this function to provide correct control positioning */
            protected abstract _mapGridNode(control: Control3D, nodePosition: JBABYLON.Vector3): void;
            /** Child classes can implement this function to provide additional processing */
            protected _finalProcessing(): void;
    }
}
declare module JBABYLON.GUI {
    /** @hidden */
    export class FluentMaterialDefines extends JBABYLON.MaterialDefines {
            INNERGLOW: boolean;
            BORDER: boolean;
            HOVERLIGHT: boolean;
            TEXTURE: boolean;
    ...
    /**
        * Class used to render controls with fluent desgin
        */
    export class FluentMaterial extends JBABYLON.PushMaterial {
            /**
                * Gets or sets inner glow intensity. A value of 0 means no glow (default is 0.5)
                */
            innerGlowColorIntensity: number;
            /**
                * Gets or sets the inner glow color (white by default)
                */
            innerGlowColor: JBABYLON.Color3;
            /**
                * Gets or sets alpha value (default is 1.0)
                */
            alpha: number;
            /**
                * Gets or sets the albedo color (Default is JBABYLON.Color3(0.3, 0.35, 0.4))
                */
            albedoColor: JBABYLON.Color3;
            /**
                * Gets or sets a boolean indicating if borders must be rendered (default is false)
                */
            renderBorders: boolean;
            ...
            hoverRadius: number;
            /**
                * Gets or sets the color used to render the hover light (default is JBABYLON.Color4(0.3, 0.3, 0.3, 1.0))
                */
            hoverColor: JBABYLON.Color4;
            /**
                * Gets or sets the hover light position in world space (default is JBABYLON.Vector3.Zero())
                */
            hoverPosition: JBABYLON.Vector3;
            /** Gets or sets the texture to use for albedo color */
            albedoTexture: JBABYLON.Nullable<JBABYLON.BaseTexture>;
            /**
                * Creates a new Fluent material
                * @param name defines the name of the material
                * @param scene defines the hosting scene
                */
            constructor(name: string, scene: JBABYLON.Scene);
            needAlphaBlending(): boolean;
            needAlphaTesting(): boolean;
            getAlphaTestTexture(): JBABYLON.Nullable<JBABYLON.BaseTexture>;
            isReadyForSubMesh(mesh: JBABYLON.AbstractMesh, subMesh: JBABYLON.SubMesh, useInstances?: boolean): boolean;
            bindForSubMesh(world: JBABYLON.Matrix, mesh: JBABYLON.Mesh, subMesh: JBABYLON.SubMesh): void;
            getActiveTextures(): JBABYLON.BaseTexture[];
            hasTexture(texture: JBABYLON.BaseTexture): boolean;
            dispose(forceDisposeEffect?: boolean): void;
            clone(name: string): FluentMaterial;
            serialize(): any;
            getClassName(): string;
            static Parse(source: any, scene: JBABYLON.Scene, rootUrl: string): FluentMaterial;
    }
}
